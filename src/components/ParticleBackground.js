...
const Particles = ({ count = 100 }) => {
  ...
  useFrame((state) => {
    ...
    particles.forEach((particle, i) => {
      ...
      const scale = Math.cos(t) * 0.8 + 1.2;
  ...
  return (
    <>
      <instancedMesh ref={mesh} args={[null, null, count]}>
        ...
        <meshPhongMaterial color="#3b82f6" emissive="#6366f1" emissiveIntensity={0.5} />
      </instancedMesh>
      <pointLight ref={light} position={[0, 0, 5]} intensity={2} color="#a855f7" />
    </>
  );
};
